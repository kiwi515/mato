...
public:
    ...
    static RPSysConfigData& getConfigData() { return sConfigData; }

    void * alloc(EGG::Heap *heap, u32 size, s32 align) { return EGG::Heap::alloc(size, align, heap); }
    void free(EGG::Heap *heap, void *mem) { return EGG::Heap::free(mem, heap); }

    EGG::Heap * getResourceHeap() const { return mResourceHeap; }
